	...
	pioneer_sync(PioneerPolicy(10), pioneer_sub, dep_sub, info_sub)
{
	...
	//simulation_sync.registerCallback(boost::bind(&PointCloudNode::simulation_callback, this, _1, _2, _3));
	// state mean
...
void PointCloudNode::simulation_callback(const nav_msgs::Odometry::ConstPtr& state_msg, const sensor_msgs::ImageConstPtr& dep, const sensor_msgs::CameraInfoConstPtr& info)
{
